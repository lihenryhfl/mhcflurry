...
python -m venv tape_mhcflurry_env
source ./tape_mhcflurry_env/bin/activate
...
python -m pip install transformers tape_proteins fair_esm
...
python -m ipykernel install --user --name=tape_mhcflurry_env
